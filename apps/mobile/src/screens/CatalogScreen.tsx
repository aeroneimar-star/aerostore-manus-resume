...
const styles = StyleSheet.create({
  ...
  nav: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', minHeight: 64 }, navActions: { flexDirection: 'row', gap: 12 }, brand: { color: theme.colors.ivory, fontFamily: theme.typography.body, fontSize: 16, fontWeight: '800', letterSpacing: 3.4 }, navButton: { paddingHorizontal: 12, paddingVertical: 8 }, navButtonText: { color: theme.colors.copperSoft, fontFamily: theme.typography.body, fontSize: 10, fontWeight: '800', letterSpacing: 1.5 }, profileLink: { color: theme.colors.copperSoft, fontFamily: theme.typography.body, fontSize: 10, fontWeight: '800', letterSpacing: 1.5, paddingVertical: 12 },
